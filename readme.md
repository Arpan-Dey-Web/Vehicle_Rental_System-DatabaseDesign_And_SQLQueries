...
[Vehicle Rental System ERD](https://drawsql.app/teams/arpan-dey/diagrams/vehicle-rental-system-database-design-sql-queries)
...
├── queries.sql # SQL queries implementing required operations
...
Responses were recorded in **Bengali** for viva practice.
...
- **GitHub Repository:** [DatabaseDesign-SQLQueries](https://github.com/Arpan-Dey-Web/Vehicle_Rental_System-DatabaseDesign_And_SQLQueries)  
- **ERD Diagram:** [Vehicle Rental System ERD](https://drawsql.app/teams/arpan-dey/diagrams/vehicle-rental-system-database-design-sql-queries)  
- **Viva Video:** [Google Drive Link](https://drive.google.com/file/d/1Pf_NZm59Azrs3Egv3JFQ9ehEw-ELEXqf/view?usp=sharing)

---

## 9. Conclusion
This project demonstrates the practical application of **relational database design** principles and **SQL query formulation** in the context of a Vehicle Rental System. The database schema ensures data integrity, supports real-world business rules, and enables retrieval of actionable information through structured queries.
